            ...
            <CardContent>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => setFormData({...formData, available_for_hire: checked})}
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) => setFormData({...formData, love_items: e.target.value.split(',').map(s => s.trim()).filter(Boolean)})}
