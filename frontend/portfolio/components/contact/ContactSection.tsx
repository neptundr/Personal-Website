...
const contactLinks = [
    ...
    // {key: 'email', icon: Mail, label: 'Email', color: 'hover:text-red hover:border-red/30'},
    ...
    // {key: 'resume_url', icon: FileText, label: 'Resume', color: 'hover:text-red-400 hover:border-red-400/30'},
];
    ...
    return (
        <section className="relative py-32 px-6 md:px-12 lg:px-24 bg-black border-t border-zinc-900 overflow-hidden">
            ...
            {settings?.email && (
              ...
              {settings.email}
                            <span
                                className="absolute bottom-0 left-0 w-0 h-[1px] bg-red-500 group-hover:w-full transition-all duration-500"/>
            </span>
                    </a>
                </motion.div>
            )}
            ...
            {settings?.resume_url && (
                ...
                >
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="px-8 py-4 rounded-full bg-red-600 hover:bg-red-700 text-white font-light tracking-wide transition-all duration-300 shadow-lg hover:shadow-red-500/20 flex items-center gap-2"
